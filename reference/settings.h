...
//   bands: [Low | Lo-Mid | Mid-Hi | High]
//   splits: kLowMidHz   = Low / Lo-Mid
//           kMidMidHz   = Lo-Mid / Mid-Hi    (the "centre" of the spectrum)
//           kMidHiHz    = Mid-Hi / High
//
// Defaults below are biased for bass-heavy material (sub band ends low,
// mid focus around 500 Hz, treble band starts at 3 kHz).
namespace crossover {
    static constexpr float kLowMidHz = 80.f;
    static constexpr float kMidMidHz = 500.f;
    static constexpr float kMidHiHz  = 3000.f;
}
...
// 3-band post EQ
// ---------------------------------------------------------------------------
// Frequencies tuned for bass-heavy EDM:
//   Low  (Sub / Punch)        80 Hz   shelf corner
//   Mid  (Presence / Body)    1 kHz   peak centre, Q
//   High (Bite / Cut)         5 kHz   shelf corner
namespace posteq {
    static constexpr float kLowFc       = 80.f;
    static constexpr float kMidFc       = 1000.f;
    static constexpr float kMidQ        = 1.f;
    static constexpr float kHighFc      = 5000.f;
